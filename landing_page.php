...
<div id="intro-text">Welcome to Le Bouchon Brasserie & Hotel, a grade II listed Georgian building which has recently undergone an extensive refurbishment programme restoring the building to its former glory.
    ...
    <div id="main-text"> <a href="<?php bloginfo('stylesheet_directory'); ?>/assets/images/Le-Bouchon-menu.png" rel="lightbox" title="Our menu"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/sample-menu.png" width="160" height="167" alt="Click to view our sample menu" /></a>
    <h2>Brasserie</h2>
